...
- [DevHub schema design](schema-design.md) defines the User, Profile, Post,
  Comment, Follow, Notification, Conversation, and Message collections before
  implementation.
- [Entity relationship diagram](er-diagram.md) visualizes collection
  cardinality and ObjectId reference direction.

Core entities planned: User, Profile, Post, Comment, Follow, Notification,
